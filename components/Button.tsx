...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-[#0a192f] text-white hover:bg-[#112240] focus:ring-[#0a192f]",
    secondary: "bg-[#64ffda] text-[#0a192f] hover:bg-[#4cdbb9] focus:ring-[#64ffda]",
    outline: "border-2 border-[#0a192f] text-[#0a192f] hover:bg-gray-100 focus:ring-gray-500",
